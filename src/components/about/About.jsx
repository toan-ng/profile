      ...
      <div className="row align-items-center">
        <div className="col-md-7 p-md-0">
          <p className="text-nowrap">
            Hi, I am &thinsp;{' '}
            <a
              href="https://dev.toann.casa"
              target="_blank"
              rel="noopener noreferrer"
              className="sub-my-name"
            >
              Toan Nguyen
            </a>{' '}
          ...
          >
            <p>
              ...
              ></i>{' '}
              I am eager to take on new challenges that allow me to learn and
              develop clean, efficient, and scalable code.{' '}
            </p>
            <p>
              I am committed to continuous self-improvement and strive to
              enhance my skills each day, contributing positively to the team
              and company.{' '}
            </p>
          </div>
